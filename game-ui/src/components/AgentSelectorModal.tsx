          ...
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {availableAgents.map((agent, index) => {
                ...
                return (
                  ...
                  >
                    <div className="bg-gradient-to-br from-white to-gray-50 rounded-xl p-6 border-2 border-gray-200 hover:border-elastic-blue shadow-lg hover:shadow-xl transition-all duration-300 transform group-hover:scale-105">
                      {/* Agent Avatar & Name */}
                      <div className="flex items-center space-x-4 mb-4">
                        ...
                        <div>
                          <h3 className="text-xl font-bold text-gray-900 group-hover:text-elastic-blue transition-colors">
                            {agent.name}
                          </h3>
                      ...
                      <div className="bg-gray-50 rounded-lg p-3 mb-4">
                        <div className="flex items-center space-x-2 mb-2">
                          ...
                          <span className="text-xs font-semibold text-gray-700 uppercase tracking-wide">Personality</span>
                        </div>
                        <p className="text-xs text-gray-600 italic">"{agent.personality}"</p>
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex flex-wrap gap-1">
                          {agent.specialties.slice(0, 3).map((specialty, idx) => (
                            <span
                              key={idx}
                              className="inline-block bg-gradient-to-r from-elastic-blue/10 to-elastic-teal/10 text-elastic-blue text-xs px-2 py-1 rounded-full border border-elastic-blue/20"
                            >
                              {specialty}
                            </span>
                          ))}
            ...
            >
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 mb-2">Fair Play Guarantee</h4>
